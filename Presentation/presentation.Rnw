...
\begin{itemize}
  \item Model diagnostics are extremely important to fitting an appropriate model.
  \item Assumption violations can lead to biased or faulty results.
  \item These plots show us that observations 124, 359, and 474 may be problematic. 
\end{itemize}

  \end{column}
  \begin{column}[c]{4.5cm}
  
<<residual plots, echo=FALSE, warning=FALSE, fig.width=4>>=
...
\begin{frame} {Leverage} %make and interpret leverage plots

<<leverage, echo=FALSE, warning=FALSE, fig.height=2.5, fig.width=4.5>>=
mat<- model.matrix(model)
lev<- hat(mat)
plot(lev, ylab="Leverages", main="Index Plot of Leverages",cex.main=0.7)
abline(h=2*7/507, col="red")
@

A "rule of thumb" is that leverages of more than 2p/n (p= # of predictors) should be looked at more closely.  Points of concern are located above the red line. 
...
{\fontsize{0.3cm}{1em}\selectfont
An \textbf{influential point} is one whose removal from the dataset causes a drastic change in the fit.  An influential point will either be an outlier in the data, will have high leverage, or will have both. Cook's Distance is a popular method of identifying influential points.}

<<influence plot, echo=FALSE, eval=FALSE>>=
influencePlot(model, main="Influence Plot",cex.main=0.7)
@
...
<<warning=FALSE, echo=FALSE, fig.height=4, tidy=TRUE>>=
cutoff <- 20/((nrow(body) - length(model$coefficients) - 8))
plot(model, which =6, cooks.levels = cutoff)
@
...
<<leap, fig.height=3.5, warning=FALSE>>=
leaps <- regsubsets(weight~height+wrist.diam+ankle.diam+chest, nbest=2, data=body)
...
\begin{column}[t]{7cm}
<<AIC_BIC_RESIDUALS,echo=FALSE,fig.height=2.7>>=
bic <- glm(gender~wrist.min+height+shoulder+hip,data=body,family="binomial")
aic <- glm(gender~wrist.min+height+shoulder+hip+chest.dep+age,data=body,family="binomial")
...
<<prdict_ability,echo=FALSE,fig.height=2.7>>=
p1=matrix(0,nrow=19,ncol=3)
i=1
for(p in seq(min(fitted(aic)),.95,.05)){
t1=table(fitted(aic)>p,body$gender)
p1[i,]=c(p,(t1[2,2])/sum(t1[,2]),(t1[1,1])/sum(t1[,1]))
i=i+1
}


p2=matrix(0,nrow=19,ncol=3)
i=1
for(p in seq(min(fitted(bic)),.95,.05)){
t2=table(fitted(bic)>p,body$gender)
...
## begin
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.95,main="Begin")
points(x2,y2,pch=3)
points(x3,y3,pch="_")
points(x4,y4,pch="_")
points(x5,y5,pch="_")
...
## 1
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.95,main="Round 1")
points(x2,y2,pch=3,col="red",cex=1.7)
points(x3,y3,pch="_")
points(x4,y4,pch="_")
points(x5,y5,pch="_")
abline(v=3,col="red")
## 11
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.7,main="Post round 1")
points(x2,y2,pch=3,cex=1.7)
points(x3,y3,pch="_",cex=0.85)
points(x4,y4,pch="_",cex=0.85)
points(x5,y5,pch="_",cex=0.85)

## 2
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.7,main="Round 2")
points(x2,y2,pch=3,cex=1.7)
points(x3,y3,pch="_",col="green3",cex=0.85)
points(x4,y4,pch="_",cex=0.85)
points(x5,y5,pch="_",cex=0.85)
abline(v=7.6,col="green3")

## 22
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.6,main="Post round 2")
points(x2,y2,pch=3,cex=1.3)
points(x3,y3,pch="_")
points(x4,y4,pch="_",cex=0.7)
points(x5,y5,pch="_",cex=0.7)

## 3
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.6,col="blue",main="Round 3")
points(x2,y2,pch=3,cex=1.3)
points(x3,y3,pch="_")
points(x4,y4,pch="_",cex=0.7,col="blue")
points(x5,y5,pch="_",cex=0.7)
abline(h=7,col="blue")

## 33
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.7,main="Post round 3")
points(x2,y2,pch=3,cex=0.9)
points(x3,y3,pch="_",cex=0.85)
points(x4,y4,pch="_",cex=0.9)
points(x5,y5,pch="_",cex=0.63)

## final
plot(x1,y1,pch=3,xlab="",ylab="",xlim=c(1,10),ylim=c(1,10),cex=0.95,main="Final")
points(x2,y2,pch=3)
points(x3,y3,pch="_")
points(x4,y4,pch="_")
points(x5,y5,pch="_")
