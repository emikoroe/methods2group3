...
\begin{figure}
  \href{https://docs.google.com/file/d/0B975xsTIaD43aUZBZ1NfbTRhWWs/edit}
       {\includegraphics[width=\textwidth]{Data_summary}}
...
\begin{center}
<<wdt,echo=FALSE, fig.height=2.5, fig.width=3.5>>=
